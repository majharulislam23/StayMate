                            ...
                            {section.items.map((item) => (
                                <li key={item.href}>
                                    ...
                                    >
                                        ...
                                        {collapsed && (
                                            <div
                                                className={`absolute left-full ml-2 px-2 py-1 text-sm font-medium rounded-md whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 ${
                                                    isDark

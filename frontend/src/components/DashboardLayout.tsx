            ...
            <div className="relative z-10 pl-64 transition-all duration-300">
                ...
                >
                    ...
                    <div className="flex items-center gap-6 flex-1">
                        {/* Search Bar */}
                        <div
                            className={`relative flex items-center max-w-md flex-1 transition-all duration-300 ${
                        ...
                        >
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-2 text-sm rounded-lg border outline-none transition-all duration-300 ${
                                    isDark
                                        ? "bg-white/5 border-white/10 text-white placeholder-slate-500 focus:border-primary-500/50 focus:bg-white/10"
                                        : "bg-slate-100 border-transparent text-slate-900 placeholder-slate-400 focus:border-primary-500 focus:bg-white"
                                }`}
                            />
                            <kbd
                                className={`absolute right-3 px-1.5 py-0.5 text-xs font-medium rounded ${
                                    isDark
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative" ref={notificationDropdownRef}>
                            ...
                            {notificationOpen && (
                                <div
                                    className={`absolute right-0 top-full mt-2 w-96 max-h-[32rem] rounded-xl shadow-xl border overflow-hidden ${
                                        isDark

...
import { Menu, X, ArrowRight, LogOut, User, Settings } from "lucide-react";
    ...
    return (
        <nav
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
                isDark
                    ? "bg-dark-900/70 border-b border-white/10"
                    : "bg-white/70 border-b border-dark-200/50"
            } backdrop-blur-xl`}
        >
                        ...
                        {isLoading ? (
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="relative">
                                    ...
                                    {profileDropdownOpen && (
                                        <div
                                            className={`absolute right-0 mt-2 w-56 rounded-xl shadow-lg border overflow-hidden animate-scale-in ${
                                                isDark
                ...
                <div
                    className={`md:hidden border-t animate-fade-in-down ${
                        isDark
                            ...
                            : "bg-white/95 border-dark-200/50"
                    } backdrop-blur-xl`}
                >
